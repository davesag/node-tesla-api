...
describe('src/api/v1/vehicles/setPreconditioningMax', () => {
  const result = ['hooray']
  ...
  const path = `/api/1/vehicles/${id}/command/set_preconditioning_max`

  const setPreconditioningMax = proxyquire(
    '../../../../../src/api/v1/vehicles/setPreconditioningMax',
    {
  ...
  before(async () => {
    await setPreconditioningMax(payload)
  })
